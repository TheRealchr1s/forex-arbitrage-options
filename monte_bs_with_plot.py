...
monte_carlo_price, S_sim = monte_carlo_simulation(S, K, r, t, sigma, N, option_type)
black_scholes_price = black_scholes_formula(S, K, r, t, sigma, option_type)

# Plot the distribution of the simulated stock prices
fig, ax = plt.subplots()
ax.hist(S_sim, bins=50, density=True)
ax.set_xlabel('Stock Price')
ax.set_ylabel('Density')
ax.set_title('Distribution of Simulated Stock Prices')
